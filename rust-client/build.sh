...
#   api.mjs            MailApi facade (import path rewritten to sibling file)
set -e
cd "$(dirname "$0")"
...
cp js/cache.mjs "$DEST/cache.mjs"

echo "deployed: $DEST/{mail_core.mjs, mail_core_bg.wasm, api.mjs, cache.mjs}"
